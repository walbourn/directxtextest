...
namespace
{
    ...
    const TestMedia g_TestMedia[] =
    {
        ...
        { FLAGS_GDI,{ 320, 240, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8X8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"rle4-absolute-320x240.bmp", { 0x72,0x8a,0xbe,0xc6,0x62,0xc6,0x01,0x49,0x54,0x35,0xef,0x3d,0xdf,0x5f,0xf2,0xbe } },
        { FLAGS_GDI,{ 320, 240, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8X8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"rle4-alternate-320x240.bmp",{ 0x29,0x29,0x4d,0x3c,0xd3,0xf5,0xcc,0x7f,0x59,0xa4,0xeb,0x46,0x9a,0xaf,0x44,0xc9 } },
        { FLAGS_GDI,{ 320, 240, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8X8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"rle4-delta-320x240.bmp",{ 0xe0,0x7b,0xa0,0xae,0xfd,0x5b,0xf7,0x58,0xfb,0x29,0x27,0xc6,0xfe,0xee,0x12,0x10 } },
        { FLAGS_GDI,{ 320, 240, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8X8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"rle4-encoded-320x240.bmp",{ 0x72,0x8a,0xbe,0xc6,0x62,0xc6,0x01,0x49,0x54,0x35,0xef,0x3d,0xdf,0x5f,0xf2,0xbe } },
        { FLAGS_GDI,{ 64000, 1, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8X8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"rle8-64000x1.bmp",{ 0xd3,0xde,0x2d,0x72,0x4f,0x19,0x55,0xb4,0x2e,0xac,0xb2,0xae,0xb2,0x29,0xde,0x74 } },
        { FLAGS_GDI,{ 320, 240, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8X8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"rle8-absolute-320x240.bmp",{ 0x72,0x8a,0xbe,0xc6,0x62,0xc6,0x01,0x49,0x54,0x35,0xef,0x3d,0xdf,0x5f,0xf2,0xbe } },
        { FLAGS_GDI,{ 160, 120, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8X8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"rle8-blank-160x120.bmp",{ 0x72,0xba,0x51,0x7c,0xbc,0x15,0x1c,0x75,0x46,0x04,0x33,0xbd,0x12,0x6c,0xd1,0x87 } },
        { FLAGS_GDI,{ 320, 240, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8X8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"rle8-delta-320x240.bmp",{ 0xe0,0x7b,0xa0,0xae,0xfd,0x5b,0xf7,0x58,0xfb,0x29,0x27,0xc6,0xfe,0xee,0x12,0x10 } },
        { FLAGS_GDI,{ 320, 240, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8X8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"rle8-encoded-320x240.bmp",{ 0x72,0x8a,0xbe,0xc6,0x62,0xc6,0x01,0x49,0x54,0x35,0xef,0x3d,0xdf,0x5f,0xf2,0xbe } },
