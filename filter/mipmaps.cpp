...
namespace
{
    ...
    const MipMapMedia g_MipMapMedia[] =
    {
        ...
        { FLAGS_NONE, { 32, 32, 1, 1, 1, 0, 0, DXGI_FORMAT_B8G8R8A8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"test8888.dds",
            ...
            {0},{0x7f,0x4f,0xe0,0x64,0x39,0x57,0x75,0x9f,0xf5,0x9f,0x8c,0xe3,0x31,0x7e,0x0e,0x77},{0x9f,0xd4,0x11,0x1a,0x50,0x5d,0xcd,0xcb,0xb7,0x15,0x1d,0x1e,0xab,0xf9,0x72,0xfc},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0xf5,0x7b,0x63,0x20,0x13,0x0a,0xa6,0x98,0x7b,0x3f,0xa7,0xb5,0xbf,0x96,0xa8,0xae},{0xd2,0x43,0xcb,0xfb,0xf6,0x5a,0xb4,0x3a,0x15,0xa0,0x1e,0x26,0x9c,0x6e,0xdc,0x0a},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0xdb,0x33,0x5d,0x8f,0x5e,0x38,0x52,0x0b,0x17,0x0d,0xe5,0xbf,0xa8,0x2e,0x00,0xdb},{0x30,0x01,0x02,0xdb,0x15,0x2a,0x3e,0x9c,0x88,0xd2,0x85,0x42,0x97,0x8c,0x19,0xcf},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x51,0xef,0xb5,0x9d,0x65,0xe9,0x15,0xc5,0x43,0xe2,0xe3,0xe9,0x27,0x23,0xd0,0x5e},{0x07,0x40,0x79,0x06,0xa2,0x8a,0x54,0x6c,0x27,0x65,0xe1,0x44,0xe8,0x0d,0xd1,0x82},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x2c,0x51,0xba,0x9e,0x1b,0xf0,0x6d,0x1b,0xcf,0x81,0x07,0xc3,0x61,0xec,0xc6,0x75},{0x3c,0x54,0x7b,0xcd,0x2a,0xb9,0x2b,0x1f,0x31,0x26,0xa5,0x49,0xb7,0x1d,0x9e,0xc4},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x5a,0x81,0x2d,0xab,0xa9,0xf0,0xcf,0xb6,0x3b,0x29,0x48,0xbf,0x3c,0xc9,0x53,0xfa},{0x92,0xc9,0xff,0x6d,0x74,0x23,0xaf,0x27,0x13,0x02,0x70,0x6d,0x1d,0x60,0x52,0xe2},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0xee,0x30,0xe8,0x93,0xa1,0xdc,0x93,0x73,0x12,0x72,0xfd,0x7f,0xb0,0x6e,0x7e,0xf4},{0x13,0x40,0xee,0x13,0xc3,0xa4,0xd8,0x68,0xb3,0xc2,0x1c,0x3a,0x8f,0x69,0xf8,0x19},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0xe8,0xc5,0xa8,0xdb,0x03,0x47,0x40,0x2d,0x3a,0x3c,0xdb,0xc6,0x5f,0x8b,0x13,0xf3},{0x74,0xd9,0x94,0xaa,0xdb,0xdd,0xe5,0x12,0x07,0x8e,0x2f,0xa1,0x8b,0x15,0x01,0xba},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x35,0x9c,0xd7,0x75,0x92,0xf4,0x2c,0x64,0xc2,0x41,0x2e,0x53,0x84,0xf7,0x39,0x10},{0x4e,0xfa,0x6e,0x2a,0xdc,0xed,0xf0,0xc3,0x98,0x5d,0x1f,0x02,0x16,0x04,0x93,0x82},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x63,0xb9,0x47,0x1e,0x16,0xb3,0x2b,0x6f,0x03,0xa2,0xec,0x84,0xa6,0xfe,0xf0,0x59},{0xa4,0x7d,0xa5,0xc4,0x2b,0x5c,0x41,0x7a,0x0d,0x61,0x86,0x58,0x1e,0xf8,0x11,0x3b},
        #else
            {0x79,0x5f,0x31,0xf9,0xbf,0xd1,0xcb,0x84,0x4b,0x3a,0x2f,0x18,0xa6,0x21,0x7f,0xa4},{0x63,0xb9,0x47,0x1e,0x16,0xb3,0x2b,0x6f,0x03,0xa2,0xec,0x84,0xa6,0xfe,0xf0,0x59},{0xd7,0x75,0xe3,0x3d,0x65,0x3a,0xf0,0xfd,0x76,0x6e,0x9a,0x62,0x5b,0xe0,0xef,0x29},
        #endif
            {0},{0} },
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x62,0xc0,0x3e,0xc2,0xa3,0xdc,0xb5,0xf4,0xe5,0x14,0xfa,0xb0,0x3d,0x9b,0x84,0xbe},{0xfe,0xa5,0xd1,0xe0,0x27,0xcc,0xc3,0x8b,0xde,0x1b,0x2e,0x7e,0x42,0x7a,0xdf,0x70},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x5b,0x83,0xe5,0x4d,0x44,0x68,0x18,0xd8,0xf2,0x02,0xb7,0xbc,0x13,0x9e,0x5d,0xcf},{0x26,0x44,0x88,0x45,0x02,0x5b,0x1e,0x9a,0x3f,0xf7,0xac,0xd0,0x93,0xf6,0xae,0x0e},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0xf0,0xe9,0xa4,0x0e,0x3d,0xd3,0x15,0xe7,0x33,0x94,0x7c,0xa7,0xbd,0xa3,0x29,0x1e},{0xf0,0xdd,0xc3,0x5d,0xc7,0x5d,0x3e,0x30,0x88,0xb9,0x68,0xc7,0x7b,0xa0,0x65,0x17},
        #else
        ...
        { FLAGS_SKIP_TOPTEST | ALTMD5(4) | ALTMD5B(10) | ALTMD5C(11), { 1280, 1024, 1, 1, 1, 0, 0, DXGI_FORMAT_YUY2, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"testpatternYUY2.dds",
            ...
            {0},{0x8d,0x79,0x59,0x08,0x26,0x11,0xeb,0x89,0x7a,0x96,0x7e,0xaa,0xcc,0xfc,0x39,0x7e},{0xe5,0xe3,0x03,0x90,0x39,0x5a,0x87,0x10,0x59,0xe7,0x6e,0x57,0x88,0xc7,0x68,0x89},
        #else
        ...
        { FLAGS_SKIP_TOPTEST | ALTMD5(5) | ALTMD5B(12) | ALTMD5C(13), { 200, 200, 1, 6, 1, TEX_MISC_TEXTURECUBE, 0, DXGI_FORMAT_YUY2, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"lenaCubeYUY2.dds",
            ...
            {0},{0x71,0x81,0xf8,0x8c,0x4d,0xf1,0x86,0xcb,0x37,0x9d,0xd8,0x98,0xa9,0xcf,0xe2,0x13},{0xc3,0x04,0xae,0xe4,0x84,0x02,0xe9,0x79,0x62,0x6f,0x6e,0xdb,0xf7,0x1e,0x65,0xa9},
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x4c,0x24,0x0f,0xa4,0xcf,0x93,0x39,0x61,0x55,0x09,0x98,0x5f,0x16,0x7a,0xd1,0x20},{0x2e,0x7d,0x37,0xb5,0xfa,0x9b,0x72,0x75,0x3e,0x04,0x50,0x6a,0x19,0x5a,0x0a,0x71},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x5d,0xbe,0xa6,0x1b,0xf2,0xd1,0x1b,0x38,0x7c,0x91,0x3c,0xf0,0x37,0x3f,0x04,0x4a},{0x73,0x95,0x8c,0xe6,0x8a,0x66,0x6e,0x76,0xb2,0x4e,0xc2,0x3a,0xc5,0x9c,0x19,0x76},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x08,0xaa,0x1e,0x81,0x31,0x2e,0xda,0xa0,0x00,0x5e,0x03,0x68,0x71,0x0d,0x09,0x30},{0xa0,0x81,0xe0,0x05,0x36,0x82,0xf6,0x90,0x58,0xa4,0xce,0x56,0xf7,0x6d,0x65,0xb3},
        #else
    ...
    const MipMapMedia g_MipMapMedia3D[] =
    {
        ...
        { FLAGS_NONE, { 200, 200, 3, 1, 1, 0, 0, DXGI_FORMAT_R8G8B8A8_UNORM, TEX_DIMENSION_TEXTURE3D }, MEDIA_PATH L"testvolip.dds",
            ...
            {0},{0xd3,0x12,0xed,0x48,0x0a,0x56,0x25,0x96,0x62,0x53,0xec,0x4c,0x61,0xfe,0x31,0x61},{0xec,0x0b,0xd1,0x97,0x18,0x32,0xa4,0xcc,0xd9,0x24,0xcd,0x8c,0x08,0x2d,0xd5,0x32},
        ...
        { ALTMD5(6), { 200, 200, 4, 1, 1, 0, 0, DXGI_FORMAT_YUY2, TEX_DIMENSION_TEXTURE3D }, MEDIA_PATH L"lenaVolYUY2.dds",
            ...
            {0},{0x1c,0xe3,0xd4,0xbd,0x62,0x11,0xe9,0x1c,0xbd,0xd7,0x8d,0xab,0x65,0x39,0x91,0xf5},{0x8e,0x5d,0x70,0x51,0xe5,0xf9,0xf4,0x7b,0xe7,0x5b,0x1a,0x60,0x8f,0x35,0x8e,0xc3},
...
// TODO - TEX_FILTER_WRAP_U, TEX_FILTER_WRAP_V
                ...
                if (!index)
                {
                    ...
                    hr = GenerateMipMaps( *srcimage.GetImage(0,0,0), TEX_FILTER_DEFAULT, 1, invalid );
                    if ( hr != E_INVALIDARG )
                    {
                        success = false;
                        printe( "Expected failure for no mip-levels! (%08X)\n", static_cast<unsigned int>(hr) );
                    }
                    ...
                    hr = GenerateMipMaps( srcimage.GetImages(), srcimage.GetImageCount(), srcimage.GetMetadata(), TEX_FILTER_DEFAULT, 1, invalid );
                    if ( hr != E_INVALIDARG )
                    {
                        success = false;
                        printe( "Expected failure for no mip-levels complex! (%08X)\n", static_cast<unsigned int>(hr) );
                    }
...
// TODO - TEX_FILTER_WRAP_U, TEX_FILTER_WRAP_V, TEX_FILTER_WRAP_W
                ...
                {
                    ScratchImage invalid;
                    hr = GenerateMipMaps3D( srcimage.GetImages(), metadata.depth, TEX_FILTER_DEFAULT, 1, invalid );
                    if ( hr != E_INVALIDARG )
                    {
                        success = false;
                        printe( "Expected failure for no mip-levels (%08X)\n", static_cast<unsigned int>(hr) );
                    ...
                    hr = GenerateMipMaps3D( srcimage.GetImages(), srcimage.GetImageCount(), srcimage.GetMetadata(), TEX_FILTER_DEFAULT, 1, invalid );
                    if ( hr != E_INVALIDARG )
                    {
                        success = false;
                        printe( "Expected failure for no mip-levels complex (%08X)\n", static_cast<unsigned int>(hr) );
                    ...
                    {
                        success = false;
                        printe( "Expected failure for invalid format complex (%08X)\n", static_cast<unsigned int>(hr) );
                    }

                    mdata2 = srcimage.GetMetadata();
                    mdata2.format = DXGI_FORMAT_BC5_UNORM;
                    hr = GenerateMipMaps3D( srcimage.GetImages(), srcimage.GetImageCount(), mdata2, TEX_FILTER_DEFAULT, INT16_MAX, invalid );
                    if ( hr != HRESULT_FROM_WIN32(ERROR_NOT_SUPPORTED) )
                    {
