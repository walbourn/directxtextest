...
{ FLAGS_SEPALPHA, { 256, 256, 1, 1, 1, 0, 0, DXGI_FORMAT_R32G32B32A32_FLOAT, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"windowslogo_rgba32f.dds",
...
{ ALTMD5(7), { 256, 256, 1, 1, 1, 0, 0, DXGI_FORMAT_R16G16B16A16_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"windowslogo_rgba16.dds",
    ...
    {0},{0} },
{ FLAGS_SKIP_POINTNOWIC | FLAGS_SKIP_SRGB, { 1920, 1200, 1, 1, 1, 0, 0, DXGI_FORMAT_R8G8B8A8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"abstract-test-pattern.jpg",
...
{ FLAGS_SKIP_SRGB, { 768, 576, 1, 1, 1, 0, 0, DXGI_FORMAT_R8G8B8A8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"Grayscale_Staircase.png",
    ...
    {0},{0} },
{ FLAGS_SKIP_TOPTEST | ALTMD5(4), { 1280, 1024, 1, 1, 1, 0, 0, DXGI_FORMAT_YUY2, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"testpatternYUY2.dds",
    ...
    {0},{0} },
{ FLAGS_SKIP_TOPTEST | ALTMD5(5), { 200, 200, 1, 6, 1, TEX_MISC_TEXTURECUBE, 0, DXGI_FORMAT_YUY2, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"lenaCubeYUY2.dds",
...
static const AltMD5 g_AltMD5[] =
{
    ...
    { {0},{0},{0x1d,0x7b,0x42,0x05,0x27,0xf0,0x44,0x10,0x93,0x75,0x44,0x68,0x93,0x8b,0xf8,0x13},
