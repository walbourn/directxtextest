...
namespace
{
    ...
    const ResizeMedia g_ResizeMedia[] =
    {
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0x86,0x5a,0x8f,0xd9,0x10,0x8f,0xcb,0xd2,0x80,0x66,0xd3,0xf5,0xc9,0xc9,0xec,0x43},{0x17,0xcd,0xe5,0x4b,0xce,0x38,0xf1,0x55,0x5a,0x6c,0x2a,0x65,0x15,0x39,0xb0,0x69},{0xc6,0xae,0x54,0x2f,0xfd,0xbf,0x1a,0x30,0xb9,0x04,0x30,0x11,0xd5,0xce,0xed,0x09},
        #else
        ...
        #if defined(_M_ARM64) || defined(_M_ARM64EC)
            {0},{0x91,0xac,0x57,0x03,0x0a,0x02,0xa0,0x0e,0xb4,0x72,0xf5,0x25,0x59,0xdd,0x29,0x48},{0x67,0xc1,0xc8,0x48,0x8f,0x35,0x7c,0x76,0xb7,0x5b,0xb8,0xc1,0x74,0xae,0x08,0x75},
        #else
            {0x4f,0x4f,0x01,0x64,0x58,0xd8,0xda,0x72,0x8b,0xb8,0x20,0x3e,0x87,0x4f,0x48,0x8a},{0x91,0xac,0x57,0x03,0x0a,0x02,0xa0,0x0e,0xb4,0x72,0xf5,0x25,0x59,0xdd,0x29,0x48},{0x67,0xc1,0xc8,0x48,0x8f,0x35,0x7c,0x76,0xb7,0x5b,0xb8,0xc1,0x74,0xae,0x08,0x75},
        #endif
            {0}, {0} },
        ...
        { ALTMD5B(8) | ALTMD5(3), 160, 128, { 1280, 1024, 1, 1, 1, 0, 0, DXGI_FORMAT_YUY2, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"testpatternYUY2.dds",
            ...
            {0x87,0x92,0xb0,0xe1,0x3f,0xff,0xe3,0xb9,0x59,0xe7,0x07,0x67,0x0a,0x36,0xbc,0x5f},{0xec,0xb7,0x75,0x97,0xe7,0x2a,0x3a,0xcb,0x95,0xf0,0x9c,0x0f,0x87,0x89,0xfc,0xa7},{0xdb,0x22,0x50,0x70,0x6f,0x1d,0x40,0xac,0x69,0xfe,0x5b,0xe2,0xde,0xed,0x11,0x19},
        #else
    ...
    {
        { {0},{0},{0},
          {0},{0xc6,0xae,0x54,0x2f,0xfd,0xbf,0x1a,0x30,0xb9,0x04,0x30,0x11,0xd5,0xce,0xed,0x09},
          {0},{0} }, // ALTMD5(1)
