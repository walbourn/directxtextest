...
namespace
{
    ...
    const FlipRotateMedia g_FlipRotateMedia[] =
    {
        ...
        { TEX_FR_ROTATE90, { 256, 256, 1, 1, 9, 0, 0, DXGI_FORMAT_B8G8R8A8_UNORM, TEX_DIMENSION_TEXTURE2D }, MEDIA_PATH L"reftexture.dds" },
...
bool TEXTest::Test04()
{
    ...
    // invalid args
    {
        ...
        HRESULT hr = FlipRotate(nullin, TEX_FR_FLIP_HORIZONTAL, image);
        ...
        hr = FlipRotate(nullptr, 0, metadata, TEX_FR_FLIP_HORIZONTAL, image);
        if (hr != E_INVALIDARG)
        {
            success = false;
